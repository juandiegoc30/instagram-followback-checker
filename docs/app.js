const I18N = {
  en: {
    ...
    privacyEyebrow:'Privacy-first', privacyTitle:'No password collection. No external backend.', privacyText:'Instagram Followback Checker runs inside your authenticated Instagram browser session. The extension does not request your password and does not store credentials on external servers.', p1:'Uses your active browser session.', p2:'Processes results locally.', p3:'Exports only when you request it.', p4:'No credential storage.',
    ...
    footerDisclaimer:'Instagram Followback Checker is an independent open-source project released under the MIT License. It is not affiliated with, endorsed by, sponsored by, or associated with Instagram, Meta, or any of their subsidiaries.'
  },
  es: {
    ...
    footerDisclaimer:'Instagram Followback Checker es un proyecto open source independiente publicado bajo licencia MIT. No está afiliado, respaldado, patrocinado ni asociado con Instagram, Meta o cualquiera de sus subsidiarias.'
  }
};
